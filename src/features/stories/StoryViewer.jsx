...
function StoryViewer({ userId, onClose }) {
  ...
  }, [currentIndex, userStories?.length, onClose, userStories]);
  ...
  return (
    <Overlay onClick={onClose}>
      <Container onClick={(e) => e.stopPropagation()}>
        ...
        {isOwn && (
          <ViewsBtn onClick={() => setShowViewsModal(true)}>
        ...
        {showDeleteModal && (
          <DeletePopup
            ...
            message="Are you to delete this story?"
            onConfirm={() =>
              deleteStory(
        ...
        <MessageBtn
          onClick={() => {
            navigate(`/messages/${current.users?.id}`);
          }}
        >
